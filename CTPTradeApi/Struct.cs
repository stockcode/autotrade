...
namespace CTPTradeApi
{
	...
	public struct CThostFtdcTradingAccountField
	{
        ...
        public override string ToString()
        {
            return String.Format("CThostFtdcTradingAccountField(经纪公司代码={0},投资者帐号={1},上次质押金额={2},上次信用额度={3},上次存款额={4},上次结算准备金={5},上次占用的保证金={6}" +
                                 ",利息基数={7},利息收入={8},入金金额={9},出金金额={10},冻结的保证金={11},冻结的资金={12},冻结的手续费={13},当前保证金总额={14},资金差额={15}" +
                                 ",手续费={16},平仓盈亏={17},期货结算准备金={18},可用资金={19},可取资金={20},基本准备金={21},交易日={22},结算编号={23},信用额度={24},质押金额={25},交易所保证金={26},投资者交割保证金={27},交易所交割保证金={28})"
                , BrokerID, AccountID, PreMortgage, PreCredit, PreDeposit, PreBalance, PreMargin, InterestBase, Interest, Deposit, Withdraw, FrozenMargin, FrozenCash, FrozenCommission
                , CurrMargin, CashIn, Commission, CloseProfit, PositionProfit, Balance, Available, WithdrawQuota, Reserve, TradingDay, SettlementID, Credit, Mortgage, ExchangeMargin, DeliveryMargin, ExchangeDeliveryMargin);
        }
	}
	...
	public struct CThostFtdcInvestorPositionField
	{
        ...
        public override string ToString()
        {
            return String.Format("CThostFtdcInvestorPositionField(合约代码={0},经纪公司代码={1},投资者代码={2},持仓多空方向={3},投机套保标志={4},持仓日期={5},上日持仓={6}" +
                                 ",今日持仓={7},多头冻结={8},空头冻结={9},多头冻结金额={10},空头冻结金额={11},开仓量={12},平仓量={13},开仓金额={14},平仓金额={15}" +
                                 ",持仓成本={16},上次占用的保证金={17},占用的保证金={18},冻结的保证金={19},冻结的资金={20},冻结的手续费={21},资金差额={22},手续费={23},平仓盈亏={24}" +
                                 ",持仓盈亏={25},上次结算价={26},本次结算价={27},交易日={28},结算编号={29},开仓成本={30},交易所保证金={31},组合成交形成的持仓={32},组合多头冻结{33}" +
                                 ",组合空头冻结={34},逐日盯市平仓盈亏={35},逐笔对冲平仓盈亏={36},今日持仓={37},保证金率={38},保证金率按手数={39})"
                , InstrumentID, BrokerID, InvestorID, PosiDirection, HedgeFlag, PositionDate, YdPosition, Position, LongFrozen, ShortFrozen, LongFrozenAmount, ShortFrozenAmount, OpenVolume, CloseVolume, OpenAmount
                , CloseAmount, PositionCost, PreMargin, UseMargin, FrozenMargin, FrozenCash, FrozenCommission, CashIn, Commission, CloseProfit, PositionProfit, PreSettlementPrice, SettlementPrice, TradingDay, SettlementID, OpenCost
                , ExchangeMargin, CombPosition, CombLongFrozen, CombShortFrozen, CloseProfitByDate, CloseProfitByTrade, TodayPosition, MarginRateByMoney, MarginRateByVolume);
        }
	}
