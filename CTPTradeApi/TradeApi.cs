...
namespace CTPTradeApi
{
	...
	public class TradeApi
	{
		...
		public TradeApi(string _investor, string _pwd, string _broker = "2030"
			, string _addr = "tcp://asp-sim2-front1.financial-trading-platform.com:26205")
		{
		...
		public int OrderInsert(string InstrumentID, EnumOffsetFlagType OffsetFlag, EnumDirectionType Direction, double Price, int Volume)
		{
		...
		public int OrderInsert(string InstrumentID, EnumOffsetFlagType OffsetFlag, EnumDirectionType Direction, int Volume)
		{
			CThostFtdcInputOrderField tmp = new CThostFtdcInputOrderField();
			tmp.BrokerID = this.BrokerID;
			tmp.BusinessUnit = null;
		...
		/// <param name="Volume"></param>
		public int OrderInsert(string InstrumentID, EnumContingentConditionType ConditionType
		...
		public int QryInstrumentMarginRate(string instrumentID,EnumHedgeFlagType hedgeFlag = EnumHedgeFlagType.Speculation)
		{ 
		...
		static extern int reqQryInstrumentMarginRate(string BROKER_ID, string INVESTOR_ID, string INSTRUMENT_ID, EnumHedgeFlagType HEDGE_FLAG);
		...
		/// <param name="Volume"></param>
		public int ParkedOrderInsert(string InstrumentID, EnumOffsetFlagType OffsetFlag, EnumDirectionType Direction, double Price, int Volume)
		{
			CThostFtdcParkedOrderField tmp = new CThostFtdcParkedOrderField();
			tmp.BrokerID = this.BrokerID;
			tmp.BusinessUnit = null;
			tmp.ContingentCondition = EnumContingentConditionType.ParkedOrder;
			tmp.ForceCloseReason = EnumForceCloseReasonType.NotForceClose;
			tmp.InvestorID = this.InvestorID;
			tmp.IsAutoSuspend = (int)EnumBoolType.No;
			tmp.MinVolume = 1;
